...
def setup_climsim_run(num_models, exp_id, base_run_id, data_vars='v1', batch_size=128):
    ...
    learning_rates = [5e-5] * num_models
    diffloss_weights = [0.0, 25.0, 0.0, 25.0]
    # mse_loss_ranges = [[0,5]] * num_models

    distloss_weights = [0.0, 0.0, 0.01, 0.005]
    ...
    for i in range(num_models):
        ...
        tconfig.loss_schedule = {'mse': [0,100], 'distribution': [2, 100] , 'diffusion': [2, 100]}
        ...
        mconfig.bl_hidden_dims = [256, 256, 256, 256] if data_vars == "v1" else [512, 256, 256]
